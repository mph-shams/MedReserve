using MedReserve.Application.Features.MedicalFiles.Commands.DeleteMedicalFile;
using MedReserve.Application.Features.MedicalFiles.Queries.DownloadMedicalFile;
using MedReserve.Application.Features.MedicalFiles.Queries.GetMedicalFilesByAppointment;
using MediatR;
